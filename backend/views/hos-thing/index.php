...
use app\models\HosThing;

$modelLabel = new \app\models\HosThing();
?>
        ...
        <div class="box-body">
          <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap table-responsive">
            <!-- row start search-->
          	<div class="row">
          	<div class="col-sm-12">
                <?php ActiveForm::begin(['id' => 'hos-thing-search-form', 'method'=>'get', 'options' => ['class' => 'form-inline'], 'action'=>Url::toRoute('hos-thing/index')]); ?>     
            ...
            <?php 
              ...
              echo '<th onclick="orderby(\'num\', \'desc\')" '.CommonFun::sortClass($orderby, 'num').' tabindex="0" aria-controls="data_table" rowspan="1" colspan="1" aria-sort="ascending" >'.$modelLabel->getAttributeLabel('num').'</th>';
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
                <?php $form = ActiveForm::begin(["id" => "hos-thing-form", "class"=>"form-horizontal", "action"=>Url::toRoute("hos-thing/save")]); ?>                      
          ...
          <div id="name_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="name" name="HosThing[name]" placeholder="必填" />
              </div>
          ...
          <div id="num_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="num" name="HosThing[num]" placeholder="必填" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="type_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="type" name="HosThing[type]" placeholder="必填" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="company_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="company" name="HosThing[company]" placeholder="必填" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="address_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="address" name="HosThing[address]" placeholder="必填" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="weight_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="weight" name="HosThing[weight]" placeholder="必填" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="update_time_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="update_time" name="HosThing[update_time]" placeholder="必填" />
              </div>
              <div class="clearfix"></div>
          </div>
...
function initModel(id, type, fun){
	...
	$.ajax({
		   type: "GET",
		   url: "<?=Url::toRoute('hos-thing/view')?>",
		   data: {"id":id},
		   cache: false,
		   dataType:"json",
...
function deleteAction(id){
	...
	if(ids.length > 0){
		admin_tool.confirm('请确认是否删除', function(){
		    $.ajax({
				   type: "GET",
				   url: "<?=Url::toRoute('hos-thing/delete')?>",
				   data: {"ids":ids},
				   cache: false,
				   dataType:"json",
				   error: function (xmlHttpRequest, textStatus, errorThrown) {
...
$('#hos-thing-form').bind('submit', function(e) {
	e.preventDefault();
	var id = $("#id").val();
	var action = id == "" ? "<?=Url::toRoute('hos-thing/create')?>" : "<?=Url::toRoute('hos-thing/update')?>";
    $(this).ajaxSubmit({
    	type: "post",
    	dataType:"json",
    	url: action,
